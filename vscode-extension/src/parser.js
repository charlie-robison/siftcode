...
function buildUnifiedDoc(originalContent, hunks) {
...
function reconstructFile(originalContent, hunks, decisions) {
  const originalLines = originalContent.split('\n');
  const outputLines = [];
  let origIndex = 0;
...
module.exports = { parseDiff, buildUnifiedDoc, reconstructFile };
